...
<html lang="en">
  <head>
    ...
    <title>TRACE4GUD - Decentralized Application</title>
  ...
  <center>
    ...
    <div style="width: 100%">
      ...
      <div class="loginformcard" id="card1">
            <h4> Welcome to TRACE4GUD - The Supply Chain DAPP</h4>
            <p style="max-width: 80%;">
            TRACE4GUD is a Decentralized E2E Logistics Application that stores the whereabouts of product at every freight hub on the Blockchain. At consumer end, customers can simply scan the QR CODE of products and get complete information about the provenance of that product hence empowering consumers to only purchase authentic and quality products.
            </p>
